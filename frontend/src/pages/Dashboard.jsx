      ...
      <main className="pl-margin-desktop p-20 pt-28">
        ...
        <div className="mb-10 p-8 rounded-[32px] bg-gradient-to-r from-blue-500/10 via-indigo-500/5 to-transparent border border-blue-500/10 dark:border-slate-800 shadow-sm relative overflow-hidden">
          <div className="relative z-10">
            <h1 className="text-3xl font-extrabold text-slate-800 dark:text-white tracking-tight mb-2">Welcome to WorkDesk ERP</h1>
            <p className="text-slate-650 dark:text-slate-350 max-w-full leading-relaxed text-sm">
              Manage your company operations from a single workspace. Access tickets, track inventory assets, process petty cash, manage couriers, update system users, and configure preferences.
            </p>
          </div>
        </div>
